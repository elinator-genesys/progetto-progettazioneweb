...
<html lang = "it">
    <head>
        <title>Circolo Tennis "Il Sombrero" - Tennis</title>
        <meta charset = "UTF-8">
    ...
    <body>
        ...
        <div id = "container">
            ...
            <div id = "right">
                <div id = "up">
                    <h2>Campi Esterni</h2>
                    <div id = "campiEsterni">
                        <div class = "campo" onclick = "sceltaCampo(1)" >
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 1</p>
                        </div>
                        <div class = "campo" onclick = "sceltaCampo(2)">
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 2</p>
                        </div>
                        <div class = "campo" onclick = "sceltaCampo(3)">
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 3</p>
                        </div>
                    </div>
                ...
                <div id = "down">
                    <h2>Campi Coperti</h2>
                    <div id = "campiCoperti">
                        <div class = "campo" onclick = "sceltaCampo(4)">
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 4</p>
                        </div>
                        <div class = "campo" onclick = "sceltaCampo(5)">
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 5</p>
                        </div>
                        <div class = "campo" onclick = "sceltaCampo(6)">
                            <img src = "../IMG/iconaTennis.png" alt = "">
                            <p>Campo 6</p>
                        </div>
                    </div>
        ...
        <div id = "popup" class = "popup">
            ...
            <form id = "prenotazione" action = "PrenotazioneCampo.php?tennis=1" method = "post">
